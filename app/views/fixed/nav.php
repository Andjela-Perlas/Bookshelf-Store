      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto text-black-50">
          ...
          <?php if(isset($_SESSION['user'])): ?>
            <li class="nav-item">
              <a class="nav-link text-white btn btn-orange mr-2 font-weight-light" href="index.php?page=logout">Odjava</a>
            </li>
            <li class="mt-2">
            ...
            <?php else: ?>
              <li class="nav-item">
                <a class="nav-link text-white btn btn-orange mr-2 font-weight-light" href="index.php?page=login">Prijava</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white btn btn-orange mr-2 font-weight-light" href="index.php?page=register">Registracija</a>
              </li>
            <?php endif; ?>
          </ul>
        </div>
