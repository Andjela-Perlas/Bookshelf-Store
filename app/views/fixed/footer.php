  ...
  <div class="container">
    <div class="d-flex justify-content-end mb-3">
      ...
      <div class="mx-2 p-2 bd-highlight">
        <?php foreach($data["networks"] as $social): ?>
          <a href="<?=$social->link ?>" class="text-white hover-icon mr-4"><i class="fab <?=$social->icon ?> fa-sm"></i> </a>
        <?php endforeach; ?>
      </div>
    </div>
    <p class="m-0 text-center text-dark font-weight-normal">Copyright &copy; BOOKSHELF 2020</p>
  </div>
  <!-- /.container -->
</footer>
