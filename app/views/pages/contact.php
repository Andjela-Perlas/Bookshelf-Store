<div class="container mt-5">
	<div class="row">
      ...
      <?php if (isset($_SESSION['message'])) : ?>
       <div class="alert alert-success font-weight-light" role="alert">
        <?= $_SESSION['message'] ?>
      </div>
    ...
    <div class="form-row">
      <div class="col-md-12 mb-3">
        <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>?page=contactInput" onsubmit="return contact();">
   ...
   <button type="submit" name="sendContact" value="Pošalji" class="btn btn-orange text-white mt-4 mb-5 font-weight-light">Pošalji</button>
 </form>
</div>
</div>
</div>