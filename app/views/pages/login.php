  ...
  <div class="row">
   <div class="col-lg-6 offset-lg-3 mt-5">
     <?php if (isset($_SESSION['noUser'])) : ?>
      <div class="alert alert-warning mt-3 font-weight-light" role="alert"><?= $_SESSION['noUser'] ?></div>
    ...
    <form method="POST" action="index.php?page=checkLogin"  onsubmit="return login();">
      ...
      <input type="submit" id="loginBtn" name="loginBtn" class="btn btn-orange text-white mt-4 mb-5 font-weight-light" value="Prijava">
    </div>
  </div>
</form>
</div>